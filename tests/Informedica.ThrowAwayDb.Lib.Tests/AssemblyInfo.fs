...
[<assembly: AssemblyTitleAttribute("Informedica.ThrowAwayDb.Lib.Tests")>]
[<assembly: AssemblyProductAttribute("Informedica.ThrowAwayDb.Lib")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Informedica.ThrowAwayDb.Lib.Tests"
    let [<Literal>] AssemblyProduct = "Informedica.ThrowAwayDb.Lib"
